...
class NeuralNetwork:
    ...
    def fit(self, X, y, learning_rate=0.2, epochs=10000):
        ...
        which chooses randomly a sample from the training data and does the
         for that sample, and this is repeated for a number of
        times (called epochs).
        We also have to set the learning rate of the algorithm,
        which determines how big a change occurs in the weights
        each time (proportionally to the errors).
